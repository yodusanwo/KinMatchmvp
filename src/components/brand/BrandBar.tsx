...
export function BrandBar({ className }: BrandBarProps) {
  ...
  return (
    <>
      <header
        className={cn(
          "flex items-center justify-between border-b border-ink/[0.12] px-5 py-4",
          className
        )}
      >
        {/* Menu button on left */}
        ...
        <Link
          ...
          aria-label={label}
        >
          <span className="font-sans text-lg font-semibold tracking-tight text-terracotta">KinMatch</span>
          <BrandMark size={24} />
        </Link>
      </header>

    ...
    <section className="rounded-2xl border border-terracotta/25 bg-terracotta/10 p-3">
      ...
      <div className="mt-2 flex items-center gap-2">
        <Link
          ...
          className="flex-1 rounded-sm bg-terracotta px-3 py-2 text-center font-sans text-xs font-medium text-white"
        >
          Capture →
        </Link>
        <button
          ...
          className="flex-1 rounded-sm border border-ink px-3 py-2 font-sans text-xs font-medium text-ink disabled:opacity-50"
        >
          Not yet
        </button>
      </div>

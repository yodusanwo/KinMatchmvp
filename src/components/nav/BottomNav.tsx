...
export function BottomNav({ heldBadge = false }: BottomNavProps) {
  ...
  return (
    <nav
      className="fixed bottom-0 left-1/2 z-20 w-full max-w-[480px] -translate-x-1/2 border-t border-ink-soft/30 bg-cream px-3 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]"
      aria-label="Main"
    >
